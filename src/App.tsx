...
const CATEGORIES: { id: Categorie; label: string; icone: string; desc: string }[] = [
    ...
    { id: 'specifique',  label: 'Demande spécifique',   icone: '✦',  desc: 'Tout autre produit ou service' },
];
                        ...
                        >
                            <div className="flex items-center gap-4">
                                ...
                                <div className="text-left">
                                    <p className="text-[14px] font-bold text-white">{cat.label}</p>
                                    <p className="text-[11px] text-gray-600 mt-0.5">{cat.desc}</p>
                                </div>
                            </div>
                            <svg
